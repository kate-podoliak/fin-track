...
export default function Registration({onToggleReg}: Reg) {
            ...
            <div className={styles.containerForm}>
                <div className={styles.wrapForm}>
                    <div className={styles.form}>
                        <p className={styles.formHeader}>Реєстрація</p>
                        <div className={styles.formBlock}>
                            <div className={styles.inputContainer}>
                                ...
                                <input type="text" id="name" className={styles.inputField} placeholder="Імʼя" value={name}
                        ...
                        <button onClick={register} className={styles.button}>Зареєструватися</button>
                        <div className={styles.separatorBlock}>
                            <div className={styles.separatorLine}></div>
                            <div className={styles.separatorText}>або</div>
                            <div className={styles.separatorLine}></div>
                        </div>
                        <div className={styles.authSocialBlock} onClick={registerGoogle}>
                            <div>
                        ...
                        <div className={styles.linkToggle}>
                            <span onClick={onToggleReg}>Вже маєте аккаунт?</span>
                        </div>
                    </div>
                </div>
            </div>
